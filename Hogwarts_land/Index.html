        ...
        <div class="form">
            <form class="signUp" action="register.php" onSubmit="get" method="post">
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5>Name</h5>
                        <input type="text" name="username" class="input" id="name" required autocomplete="off" />
                    </div>
                </div>
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5>Email Address</h5>
                        <input type="email" name="email" class="input" id="userName" required autocomplete="off" />
                    </div>
                </div>
                <div class="input-div one">
                    <div class="i">
                    ...
                    <div class="div">
                        <h5>Phone Number</h5>
                        <input type="text" name="phone" class="input" id="contactNo" required autocomplete="off" />
                    </div>
                </div>
                <div class="input-div one">
                    <table>
                ...
                <div class="input-div pass">
                    ...
                    <div class="div">
                        <h5>Password</h5>
                        <input type="password" class="input" name="password1" id="password" pattern="(?=.*[a-z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required autocomplete="off" />
                    </div>
                </div>
                <div class="checkBox">
            ...
            <form class="login" action="" method="post">
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5>Username</h5>
                        <input type="text" class="input" name="userid" id="username" required autocomplete="off" />
                    </div>
                </div>
                <div class="input-div pass">
                    <div class="i">
                    ...
                    <div class="div">
                        <h5>Password</h5>
                        <input type="password" class="input" name="pswrd" id="password" required autocomplete="off" />
                    </div>
                </div>
                <div class="checkBox">
                    <input type="checkbox" name="checkbox" id="checkbox" required />
