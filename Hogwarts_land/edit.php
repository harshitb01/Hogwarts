...
<body style="background-color: #004528;">
	...
	if (isset($_POST['submit'])) {
		...
		$sql1 = "UPDATE register SET user_image='$user_image', first='$first', last='$last', username='$username', password='$password', email='$email', phone='$phone' WHERE username='" . $_SESSION['login_user'] . "';";
